...
data= proc %>% select(rbd, puntaje_leng, puntaje_mate, ingresos, ingresos_t, sexo, cultura, educacion, nacionalidad, etnia)
...
data_agg= data %>%
  ...
  mutate(sd_ingresos_t = sd(ingresos_t)) %>% 
  mutate(m_ingresos_t = mean(ingresos_t)) %>% as.data.frame()
