...
```{r, echo=FALSE, results='asis'}
stargazer(data_agg_d, title= "Descriptivos de establecimientos", type = 'html')
```
...
## grupal
results_2= lmer(puntaje_mate ~ 1 + m_ingresos + sd_educacion + sd_ingresos + m_educacion + nacionalidad_j + etnia_j + sexo_j + (1|rbd), data=data_agg)

screenreg(results_2)

##multinivel
results_3 = lmer(puntaje_mate ~ 1 + log(ingresos) + sexo + educacion + nacionalidad + etnia + sd_ingresos + m_educacion + sd_educacion + m_ingresos + nacionalidad_j + etnia_j + sexo_j + (1|rbd), data = data_agg)
...
## grupal
results_5= lmer(puntaje_leng ~ 1 + m_ingresos + sd_educacion + sd_ingresos + m_educacion + nacionalidad_j + etnia_j + sexo_j + (1|rbd), data=data_agg)

screenreg(results_5)

##multinivel
results_6 = lmer(puntaje_leng ~ 1 + log(ingresos) + sexo + educacion + nacionalidad + etnia + sd_ingresos + m_educacion + sd_educacion + m_ingresos + nacionalidad_j + etnia_j + sexo_j + (1|rbd), data = data_agg)
...
results_8 = lmer(puntaje_mate ~ 1 + m_ingresos + bajo_nse + m_ingresos*bajo_nse + log(ingresos) + sexo + educacion + nacionalidad + etnia + m_educacion + sd_educacion + sd_ingresos + nacionalidad_j + etnia_j + sexo_j + (1|rbd), data = data_agg)

screenreg(results_8, naive=TRUE)

##probamos interaccion bajo nse mean ingresos lenguaje
results_9 = lmer(puntaje_leng ~ 1 + m_ingresos + bajo_nse + m_ingresos*bajo_nse + log(ingresos) + sexo + educacion + nacionalidad + etnia + m_educacion + sd_educacion + sd_ingresos + nacionalidad_j + etnia_j + sexo_j + (1|rbd), data = data_agg)
...
Teniendo a la vista estos datos, cabe preguntarte entonces qué tipo de configuración de los establecimientos escolares es más deseable en lo que respecta a su composición socioecónomica. Por un lado, los datos nos inducen a pensar que una mayor heterogeneidad de los establecimientos genera un efecto agregado perjudicial sobre el rendimiento de los estudiantes. Por otro, los estudiantes más pobres mejoran más su rendimiento que los alumnos no pobres a medida que el contexto socioecónomico del colegio es más favorable. Ante esta ambivalencia, no es claro la forma en la que se debiesen distribuir los alumnos en el sistema educacional, sólo pensando en maximizar el rendimiento académico de ellos.

###Interacción entre composición de género y sexo

```{r, echo=FALSE, results='hide'}
##matematica
results_12 = lmer(puntaje_mate ~ 1 + log(ingresos) + sexo + educacion + nacionalidad + etnia + sd_ingresos + m_educacion + sd_educacion + m_ingresos + nacionalidad_j + etnia_j + sexo_j*sexo + (1|rbd), data = data_agg)

screenreg(results_12)

##lenguaje

results_15 = lmer(puntaje_leng ~ 1 + log(ingresos) + sexo + educacion + nacionalidad + etnia + sd_ingresos + m_educacion + sd_educacion + m_ingresos + nacionalidad_j + etnia_j + sexo_j*sexo + (1|rbd), data = data_agg)
...
htmlreg(list(results_12, results_15),
    ...
    custom.coef.names = c("Intercepto", "Ingresos" ,"Mujer", "Educación", "Migrante", "Indígena", "Heterogeneidad social", "Promedio nivel educativo", "Heterogeneidad educativa", "Promedio ingresos", "Homogeneidad migratoria alta", "Homogeneidad migratoria baja", "Homogeneidad étnica alta", "Homogeneidad étnica baja", "Alta homogeneidad género", "Baja homogeneidad género", "Interacción mujer homogéneo alto", "Interacción mujer homogéneo bajo"),
    custom.note = "%stars. Errores estándar en paréntesis",
...
```{r, echo=FALSE, results='hide'}
##lenguaje
results_13 = lmer(puntaje_leng ~ 1 + log(ingresos) + sexo + educacion + nacionalidad + etnia + sd_ingresos + m_educacion + sd_educacion + m_ingresos + nacionalidad_j + etnia_j*etnia + sexo_j + (1|rbd), data = data_agg)

screenreg(results_13)

##matematica
results_10 = lmer(puntaje_mate ~ 1 + log(ingresos) + sexo + educacion + nacionalidad + etnia + sd_ingresos + m_educacion + sd_educacion + m_ingresos + nacionalidad_j + etnia_j*etnia + sexo_j + (1|rbd), data = data_agg)
...
htmlreg(list(results_10, results_13),
    custom.model.names = c("Modelo SIMCE Matemática","Modelo SIMCE Lenguaje"),
    custom.coef.names = c("Intercepto", "Ingresos" ,"Mujer", "Educación", "Migrante", "Indígena", "Heterogeneidad social", "Promedio nivel educativo", "Heterogeneidad educativa", "Promedio ingresos", "Homogeneidad migratoria alta", "Homogeneidad migratoria baja", "Homogeneidad étnica alta", "Homogeneidad étnica baja", "Alta homogeneidad género", "Baja homogeneidad género", "Interacción indígena homogéneo alto", "Interacción indígena homogéneo bajo"),
    custom.note = "%stars. Errores estándar en paréntesis",
...
results_14 = lmer(puntaje_leng ~ 1 + log(ingresos) + sexo + educacion + nacionalidad + etnia + sd_ingresos + m_educacion + sd_educacion + m_ingresos + nacionalidad_j*nacionalidad + etnia_j + sexo_j + (1|rbd), data = data_agg)

screenreg(results_14)

##matematica
results_11 = lmer(puntaje_mate ~ 1 + log(ingresos) + sexo + educacion + nacionalidad + etnia + sd_ingresos + m_educacion + sd_educacion + m_ingresos + nacionalidad_j*nacionalidad + etnia_j + sexo_j + (1|rbd), data = data_agg)
...
htmlreg(list(results_11, results_14),
    custom.model.names = c("Modelo SIMCE Matemática","Modelo SIMCE Lenguaje"),
    custom.coef.names = c("Intercepto", "Ingresos" ,"Mujer", "Educación", "Migrante", "Indígena", "Heterogeneidad social", "Promedio nivel educativo", "Heterogeneidad educativa", "Promedio ingresos", "Homogeneidad migratoria alta", "Homogeneidad migratoria baja", "Homogeneidad étnica alta", "Homogeneidad étnica baja", "Alta homogeneidad género", "Baja homogeneidad género", "Interacción migrante homogéneo alto", "Interacción migrante homogéneo bajo"),
    custom.note = "%stars. Errores estándar en paréntesis",
